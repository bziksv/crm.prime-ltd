            ...
            <div class="p-2 w-100">
                ...
                <p>
                    ...
                    if ($log->action === "created") {
                        ...
                        $label_class = "danger";
                    } else if ($log->action === "checklist_item_unchecked") {
                        $label_class = "warning";
                    } else if ($log->action === "checklist_item_updated") {
                        $label_class = "warning";
                    } else if ($log->action === "checklist_item_deleted") {
                        $label_class = "danger";
                    } else if ($log->action === "checklist_item_added" || $log->action === "checklist_item_checked") {
                        $label_class = "success";
                    }
                    ...
                    if ($log->action === "bitbucket_notification_received" || $log->action === "github_notification_received") {
                        ...
                        $label_class = "info";
                    } else if (strpos($log->action, "checklist_item_") === 0) {
