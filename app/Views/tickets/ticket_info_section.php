<div class="card p15 ticket-info-card" id="subscription-info-section">
    <div class="clearfix p15">
        <div class="row">
            ...
            <div class="col-md-12 mb15">
                ...
                $status_for_badge = $ticket_info->status;
                if ($status_for_badge === "client_replied" && $login_user->user_type === "client") {
                    $status_for_badge = "open";
                }

                echo "<span class='badge $ticket_status_class large'>" . app_lang($status_for_badge) . "</span> ";
                ?>
            </div>
